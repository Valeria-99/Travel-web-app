...
const Data = [
    ...
    },
    {
        ...
        grade:'CULTURAL RELAX',
        fees:'$840',
        description:'"Cinque Terre" is a famous tourist destination in Italy and a UNESCO World Heritage site. It is located in the northwestern region of Liguria along the Mediterranean coastline and consists of five picturesque villages, from north to south: Monterosso, Vernazza, Corniglia, Manarola, and Riomaggiore.'
    },
    {
        id:7,
        imgSrc: img7,
        ...
        grade:'CULTURAL RELAX',
        fees:'$790',
        description:'Angkor Wat is a world-renowned archaeological site located in Cambodia. It stands as one of the most iconic and impressive historical landmarks globally, representing the artistic and architectural achievements of the Khmer civilization.'
    },
    {
        id:8,
        imgSrc: img8,
